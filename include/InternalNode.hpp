...
public:
    ...
    void redist_left(TreeNode* left_child_node,TreeNode* child_node,int ind);
    void redist_right(TreeNode* right_child_node,TreeNode* child_node,int ind);
    void merge(TreeNode* left_child_node,TreeNode* child_node,int ind);
    

    vector<TreePtr> pop_elements(int start_ind,int end_ind);
    void push_elements(int position,vector<TreePtr> pointers,bool right);
